...
_FLINKJOB_FLINKLOGPROPERTIESENTRY = _descriptor.Descriptor(
  name='FlinkLogPropertiesEntry',
  full_name='flyteidl_flink.FlinkJob.FlinkLogPropertiesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flyteidl_flink.FlinkJob.FlinkLogPropertiesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='flyteidl_flink.FlinkJob.FlinkLogPropertiesEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FLINKJOB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flinkLogProperties', full_name='flyteidl_flink.FlinkJob.flinkLogProperties', index=8,
  ...
  nested_types=[_FLINKJOB_FLINKPROPERTIESENTRY, _FLINKJOB_FLINKLOGPROPERTIESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_FLINKJOB_FLINKLOGPROPERTIESENTRY.containing_type = _FLINKJOB
...
_FLINKJOB.fields_by_name['flinkLogProperties'].message_type = _FLINKJOB_FLINKLOGPROPERTIESENTRY
...
FlinkJob = _reflection.GeneratedProtocolMessageType('FlinkJob', (_message.Message,), dict(
  ...
  FlinkLogPropertiesEntry = _reflection.GeneratedProtocolMessageType('FlinkLogPropertiesEntry', (_message.Message,), dict(
    DESCRIPTOR = _FLINKJOB_FLINKLOGPROPERTIESENTRY,
    __module__ = 'flyteidl_flink.flink_pb2'
    # @@protoc_insertion_point(class_scope:flyteidl_flink.FlinkJob.FlinkLogPropertiesEntry)
    ))
  ,
...
_sym_db.RegisterMessage(FlinkJob.FlinkLogPropertiesEntry)
...
_FLINKJOB_FLINKLOGPROPERTIESENTRY._options = None
